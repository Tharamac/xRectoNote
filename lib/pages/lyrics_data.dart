  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProjectListCubit, List<SongProject>>(
      builder: (context, state){
        noteController.text = state[widget.selectedDataIdx].note;
        return Scaffold(
          appBar: AppBar(
            ...
            padding: EdgeInsets.only(right: 20.0),
              ...
              onTap: () {
                  state[widget.selectedDataIdx].note = noteController.text;
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text("Lyrics : ",
                      style: TextStyle(color: Colors.white,fontSize: 25, fontWeight: FontWeight.w600, fontStyle: FontStyle.italic),
                    ),
                    FlatButton(
                      child: Text("Edit Lyrics",style: TextStyle(color: RectoNoteColors.colorPrimary, fontSize: 20, fontWeight: FontWeight.w600)),
                      onPressed: null,
                    )
                  ],
                ),
                Expanded(
                  ...
                  child: Container(
                    ...
                    style: TextStyle(color: Colors.white,fontSize: 20, fontWeight: FontWeight.w300, height: 1.2)
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                          borderSide: BorderSide(color: RectoNoteColors.colorPrimaryDark)
                        )
                      ),
                      style: TextStyle(color: Colors.white,fontSize: 20, fontWeight: FontWeight.w300, height: 1.2),
                    )
